    ...
    <div class="container">
        ...
        <ul class="pivots">
                ...
                <ul id="core">
                        ...
                        <ul id="core_overview" class="cardsC">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Začínáme s ASP.NET Core</h3>
                                                    <p>Vytvořte za 5 minut první aplikaci ASP.NET pro libovolnou platformu.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Úvod do ASP.NET Core</h3>
                                                    <p>Objevte nové koncepty v ASP.NET Core a zjistěte, jak vám můžou pomoct při vývoji moderních webových aplikací.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Přehled ASP.NET Core MVC</h3>
                                                    <p>Naučte se vytvářet webové aplikace a rozhraní API podle návrhu MVC.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Základy</h3>
                                                    <p>Naučte se základy ASP.NET Core.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bezplatné kurzy</h3>
                                                    <p>Naučte se vytvářet aplikace v ASP.NET Core a získejte od různých zprostředkovatelů zdarma školení.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="fullSpan">
                                <div class="container footer">
                                    <p><a href="https://github.com/aspnet/Docs/blob/master/CONTRIBUTING.md">Přispět dokumenty a ukázkami pro ASP.NET Core</a></p>
                                </div>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="core_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Vybrané kurzy | <a href="https://docs.microsoft.com/aspnet/core/tutorials/" data-raw-source="[View all ASP.NET Core tutorials](https://docs.microsoft.com/aspnet/core/tutorials/)">Zobrazit všechny kurzy k ASP.NET Core</a></p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sestavení webu na počítači Mac</h3>
                                                    <p>Sestavte první aplikaci ASP.NET Core na počítači Mac pomocí sady Visual Studio pro Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sestavení webu v sadě Visual Studio pro Windows</h3>
                                                    <p>Sestavte první aplikaci ASP.NET Core MVC v sadě Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sestavení webového rozhraní API</h3>
                                                    <p>Sestavte první webové rozhraní API pomocí ASP.NET Core MVC a sady Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Začínáme s Entity Framework Core a ASP.NET Core</h3>
                                                    <p>Vytvářejte webové aplikace ASP.NET Core s architekturou MVC, které pro přístup k datům používají technologii Entity Framework Core.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Stránky nápovědy k rozhraní API pro ASP.NET Web využívající Swagger</h3>
                                                    <p>Vygenerujte dokumentaci a stránky nápovědy k rozhraní API pro ASP.NET Web. Použijte k tomu Swagger a Swashbuckle.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nasazení webové aplikace ASP.NET Core do Azure pomocí sady Visual Studio</h3>
                                                    <p>Vytvořte webovou aplikaci ve službě Azure App Service a nasaďte do ní webovou aplikaci ASP.NET Core.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="fullSpan">
                                <div class="container footer">
                                    <p><a href="https://github.com/aspnet/Docs/blob/master/CONTRIBUTING.md">Přispět dokumenty a ukázkami pro ASP.NET Core</a></p>
                                    <p><a href="https://docs.microsoft.com/dotnet/articles/project-json">Najít verzi dokumentace pro Visual Studio 2015/project.json</a></p>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="aspnet">
                    <li>
                        <a href="#aspnet_overview">Přehled</a>
                        <ul id="aspnet_overview" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>ASP.NET je vyspělá webová platforma, která poskytuje všechny služby nezbytné k sestavování podnikových webových aplikací založených na serveru pomocí rozhraní .NET ve Windows.</p>
                                    <p><a href="https://docs.microsoft.com/aspnet/core/choose-aspnet-framework" data-raw-source="[Learn the benefits of both ASP.NET Core and ASP.NET](https://docs.microsoft.com/aspnet/core/choose-aspnet-framework)">Přečtěte si o výhodách rozhraní ASP.NET Core a ASP.NET</a> a vyberte si z nich to, které je pro vás nejvhodnější.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Stažení sady Visual Studio</h3>
                                                    <p>Visual Studio je bezplatné integrované vývojové prostředí pro ASP.NET ve Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Úvod do ASP.NET</h3>
                                                    <p>Porovnejte technologie ASP.NET pro vytváření webových aplikací a webových rozhraní API a přidávání funkcí v reálném čase.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Referenční dokumentace k rozhraní API technologie ASP.NET</h3>
                                                    <p>Prozkoumejte knihovnu tříd ASP.NET.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Webová rozhraní API</h3>
                                                    <p>Naučte se vytvářet webová rozhraní API pomocí rozhraní API pro ASP.NET Web 2 a sady Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bezplatné kurzy</h3>
                                                    <p>Naučte se vytvářet aplikace pomocí ASP.NET z bezplatných kurzů od různých poskytovatelů školení.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="fullSpan">
                                <div class="container footer">
                                    <p><a href="https://github.com/aspnet/Docs/blob/master/CONTRIBUTING.md">Přispět do dokumentů a ukázek ASP.NET</a></p>
                                </div>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="aspnet_framework" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p><a href="/aspnet/overview#websites-and-web-applications">Získejte informace o různých možnostech vytváření webů s ASP.NET</a> a vyberte si tu nejvhodnější.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MVC</h3>
                                                    <p>Účinný způsob sestavování dynamických webů, který je založený na vzorcích a umožňuje jasně oddělit oblasti zájmu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rychlý, přístupný a jednoduchý způsob kombinování serverového kódu s HTML při vytváření obsahu dynamického webu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SignalR</h3>
                                                    <p>Přidejte do aplikací webové funkce v reálném čase.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="aspnet_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Vybrané kurzy | <a href="https://docs.microsoft.com/aspnet/tutorials/" data-raw-source="[View all ASP.NET tutorials](https://docs.microsoft.com/aspnet/tutorials/)">Zobrazit všechny kurzy k ASP.NET</a></p>
                                </div>
                            </li>
                            <li>
                                <a href="https://docs.microsoft.com/aspnet/mvc/overview/getting-started/introduction/getting-started">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Začínáme s ASP.NET MVC 5</h3>
                                                    <p>V této řadě kurzů se seznámíte se základy vytváření webových aplikací ASP.NET MVC 5 v sadě Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Začínáme s funkcí SignalR 2</h3>
                                                    <p>V tomto kurzu se naučíte používat funkci SignalR k vytvoření aplikace pro chatování v reálném čase.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Začínáme s Entity Framework 6 Code First pomocí MVC 5</h3>
                                                    <p>Seznamte se se základními způsoby použití sady Entity Framework 6 k zobrazení a úpravě dat v aplikaci ASP.NET MVC 5.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migrace aplikací ASP.NET MVC do kontejnerů s Windows</h3>
                                                    <p>Naučte se spouštět stávající aplikaci ASP.NET MVC v kontejneru Windows Docker.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
