...
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>Iterace č. 4 – vytvoření volně spárované aplikace (C#)
...
**Výpis 1 - Modely\IContactManagerRepository.cs**
...
**Výpis 2 - Modely\EntityContactManagerRepository.cs**
...
**Výpis 4 - Modely\ContactManagerService.cs**
...
**Výpis 5 - Modely\IContactManagerService.cs**
...
**Výpis 6 - Řadiče\ContactController.cs**
...
**Výpis 7 - Modely\Validation\ModelStateWrapper.cs**

[!code-csharp[Main](iteration-4-make-the-application-loosely-coupled-cs/samples/sample7.cs)]

**Výpis 8 - Modely\Validation\IValidationDictionary.cs**
