...
title: 'Iterace #5 – vytvořit testy částí (C#) | Dokumenty společnosti Microsoft'
...
ms.locfileid: "81542349"
---
# <a name="iteration-5--create-unit-tests-c"></a>Iterace č. 5 – vytvoření testů jednotek (C#)
...
4. Přidejte odkaz na sestavení Moq klepnutím pravým tlačítkem myši na složku Reference v projektu ContactManager.Tests a výběrem **možnosti Přidat odkaz**. Na kartě Procházet vyhledejte složku, ve které jste rozbalili Moq, a vyberte sestavení Moq.dll. Klikněte na tlačítko **OK.**
5. Po dokončení těchto kroků by měla složka Reference vypadat jako obrázek 2.

[![Odblokování Moq](iteration-5-create-unit-tests-cs/_static/image1.jpg)](iteration-5-create-unit-tests-cs/_static/image1.png)

**Obrázek 01**: Odblokování Moq[(Klikněte pro zobrazení full-size image)](iteration-5-create-unit-tests-cs/_static/image2.png)

[![Odkazy po přidání Moq](iteration-5-create-unit-tests-cs/_static/image2.jpg)](iteration-5-create-unit-tests-cs/_static/image3.png)

**Obrázek 02**: Reference po přidání Moq(Klikněte[pro zobrazení full-size image)](iteration-5-create-unit-tests-cs/_static/image4.png)
...
Vytvořte novou složku s názvem Modely v projektu ContactManager.Tests. Dále klepněte pravým tlačítkem myši na složku Modely a vyberte **přidat, nový test**. Zobrazí se dialogové okno **Přidat nový test** zobrazené na obrázku 3. Vyberte šablonu **Testování částí** a pojmenujte novou testovací ContactManagerServiceTest.cs. Kliknutím na tlačítko **OK** přidáte nový test do testovacího projektu.
...
[![Modely\ContactManagerServiceTest.cs](iteration-5-create-unit-tests-cs/_static/image3.jpg)](iteration-5-create-unit-tests-cs/_static/image5.png)

**Obrázek 03**: Modely\ContactManagerServiceTest.cs([Klepnutím zobrazíte obrázek v plné velikosti](iteration-5-create-unit-tests-cs/_static/image6.png))
...
**Výpis 1 - Modely\ContactManagerServiceTest.cs**
...
> [!NOTE] 
> 
> Při použití moq framework, je \_rozdíl mezi \_mockRepository a mockRepository.Object. První odkazuje na Mock&lt;IContactManagerRepository třídy,&gt; která obsahuje metody pro určení, jak mock úložiště bude chovat. Ten odkazuje na skutečné mock úložiště, které implementuje rozhraní IContactManagerRepository.
...
Aplikace ASP.NETMVC řídí tok interakce s uživatelem. Při testování řadiče, chcete otestovat, zda řadič vrátí správný výsledek akce a zobrazit data. Můžete také chtít otestovat, zda řadič spolupracuje s třídami modelu očekávaným způsobem.
