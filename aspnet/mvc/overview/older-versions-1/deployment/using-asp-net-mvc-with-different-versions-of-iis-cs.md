...
title: Použití ASP.NET MVC s různými verzemi služby IIS (C#) | Dokumenty společnosti Microsoft
...
[![Dialogové okno New Project (Nový projekt)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image1.jpg)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image1.png)

**Obrázek 1**: Detekce režimu zpracování[požadavku(Kliknutím zobrazíte obrázek v plné velikosti)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.png)
...
[![Dialogové okno New Project (Nový projekt)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.jpg)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image3.png)

**Obrázek 2**: Příjem chyby 404 Not Found[(Kliknutím zobrazíte obrázek v plné velikosti)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png)
...
[![Dialogové okno New Project (Nový projekt)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image3.jpg)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image5.png)

**Obrázek 3**: Vytvoření mapy skriptů se zástupnými symboly se službou IIS 7.0([Klepnutím zobrazíte obrázek v plné velikosti)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image6.png)
...
[![Dialogové okno New Project (Nový projekt)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.jpg)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image7.png)

**Obrázek 4**: Vytvoření mapy skriptů se zástupnými symboly se službou IIS 6.0([Klepnutím zobrazíte obrázek v plné velikosti)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image8.png)
...
[![Dialogové okno New Project (Nový projekt)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image5.jpg)](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image9.png)
