...
**Obrázek 1**: Přidání odkazu na pořadač modelu datových poznámk[(Kliknutím zobrazíte obrázek v plné velikosti)](validation-with-the-data-annotation-validators-cs/_static/image3.png)
...
Tento řádek kódu registruje ataAnnotationsModelBinder jako výchozí pořadač modelu pro celou ASP.NET aplikaci MVC.
...
**Obrázek 6**: Použití validátorů s rozhraním Entity Framework[(Klepnutím zobrazíte obrázek v plné velikosti)](validation-with-the-data-annotation-validators-cs/_static/image14.png)
