...
5. Kliknutím na **App Service** *oddíl App Service* **vytvořte nový** **App Service plán** (může to být stejný název jako App Service), **umístění**a **cenová úroveň** (bezplatná možnost).
...
10. Podle potřeby upravte [kolaci](/sql/relational-databases/collations/collation-and-unicode-support) .
