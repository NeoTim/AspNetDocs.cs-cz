...
>
> [Tento problém GitHubu](https://github.com/dotnet/AspNetDocs/issues/116) použijte k nahlášení problémů se službou Microsoft Ajax CDN.
...
Technologie Microsoft Ajax Content Delivery Network (CDN) hostuje oblíbené knihovny JavaScript třetích stran, jako je jQuery, a umožňuje je snadno přidat do svých webových aplikací. Například můžete začít používat jQuery, který je hostován v tomto CDN jednoduše přidáním &lt; &gt; značky skriptu na stránku, která odkazuje na AJAX.aspnetcdn.com.
...
Pokud chcete odeslat knihovnu JavaScriptu a vaše knihovna je jedním z hlavních knihoven JavaScriptu (jak je uvedeno v části http://trends.builtwith.com) nebo rozšíření/moduly plug-in do těchto knihoven, které jsou (a) oblíbené; nebo (b) užitečné pro použití v ASP.NET, pak prosím kontaktujte AjaxCDNSubmission@Microsoft.com .
...
- Knihovna jQuery knihovna &mdash; uživatelského rozhraní jQuery závisí na knihovně jQuery. Knihovnu jQuery je nutné přidat na stránku před přidáním knihovny uživatelského rozhraní jQuery.
...
#### <a name="jquery-version-351"></a>jQuery verze 3.5.1
...
#### <a name="jquery-version-350"></a>jQuery verze 3.5.0
...
#### <a name="bootstrap-version-452"></a>Bootstrap verze 4.5.2
...
#### <a name="bootstrap-version-450"></a>Bootstrap verze 4.5.0
...
Následující verze [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") spouštěcích TouchCarousel vydání se hostují v síti CDN:
