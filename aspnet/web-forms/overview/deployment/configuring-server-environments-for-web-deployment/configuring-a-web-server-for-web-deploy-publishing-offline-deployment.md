...
> 
> Když pracujete s nástrojem Internetová informační služba (IIS) web pro nasazení webu (Nasazení webu) 2,0 nebo novější, existují tři hlavní přístupy, pomocí kterých můžete své aplikace nebo weby získat na webový server. Další možnosti:
> 
...
- **Nástroj pro nasazení webu 2,1 nebo novější**. Tím se nainstaluje Nasazení webu (a jeho základní spustitelný soubor MSDeploy.exe) na vašem serveru. Nasazení webu se integruje se službou IIS a umožňuje importovat a exportovat webové balíčky.
